...
namespace TP.ConcurrentProgramming.Presentation.ViewModel.Test
{
    ...
    public class MainWindowViewModelUnitTest
    {
        ...
        private class ModelNullFixture : ModelAbstractApi
        {
            ...
            public override double ScaleHeight { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
            public override double ScaleWidth { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
